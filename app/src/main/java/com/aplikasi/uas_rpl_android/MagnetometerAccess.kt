...
class MagnetometerAccess : AppCompatActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_magnetometer_access)
        //
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        DegreeTV!!.text = "Heading: " + java.lang.Float.toString(degree) + " degrees"
